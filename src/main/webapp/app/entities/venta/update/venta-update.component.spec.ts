...
describe('Venta Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Dispositivo query and add missing value', () => {
      ...
      const dispositivo: IDispositivo = { id: 5678 };
      venta.dispositivo = dispositivo;

      const dispositivoCollection: IDispositivo[] = [{ id: 4774 }];
    ...
    it('Should call Personalizacion query and add missing value', () => {
      ...
      const personalizacionCollection: IPersonalizacion[] = [{ id: 1307 }];
    ...
    it('Should call Adicional query and add missing value', () => {
      const venta: IVenta = { id: 456 };
      const adicionales: IAdicional[] = [{ id: 30361 }];
      venta.adicionales = adicionales;

      const adicionalCollection: IAdicional[] = [{ id: 22255 }];
    ...
    it('Should update editForm', () => {
      const venta: IVenta = { id: 456 };
      const dispositivo: IDispositivo = { id: 18645 };
      venta.dispositivo = dispositivo;
      const personalizaciones: IPersonalizacion = { id: 954 };
      venta.personalizaciones = [personalizaciones];
      const adicionales: IAdicional = { id: 11751 };
      venta.adicionales = [adicionales];
